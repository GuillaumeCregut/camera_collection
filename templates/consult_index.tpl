...
<body>
	<div id="Corps">
		...
		<ul id="Listemenu">
		 <li><a href="view.php?NumPage=1">{$Pays}</a></li>
		 <li><a href="view.php?NumPage=2">{$TypeSupp}</a></li>
		 <li><a href="view.php?NumPage=3">{$Perio}</a></li>
		 <li><a href="view.php?NumPage=4">{$Forma}</a></li>
		 <li><a href="view.php?NumPage=5">{$TypeMat}</a></li>
		 <li><a href="view.php?NumPage=6">{$Obtu}</a></li>
		 <li><a href="view.php?NumPage=7">{$Montu}</a></li>
		 <li><a href="view.php?NumPage=8">{$TypeApp}</a></li>
		 <li><a href="view.php?NumPage=9">{$Mark}</a></li>
