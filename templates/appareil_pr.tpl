...
<div id="Corps">
	...
	<div id="perso">
		<h2>{$Perso}</h2>
		<div class="BlocInfo">
			<p><span  class="definition">{$Ref_Inv} :</span><span class="valeur"> {$Info_Inv}</span></p>
			<p><span  class="definition">{$Etat} :</span><span class="valeur"> {$Info_Etat}</span></p>
			<p><span  class="definition">{$Prix} :</span><span class="valeur"> {$Info_Prix} {$money}</span></p>
			<p><span  class="definition">{$Note_P} :</span></p>
			<p class="texte">{$Info_P}</p>
		</div>
	</div>
	<h2>{$Photos}</h2>
	{$lesphotos}
